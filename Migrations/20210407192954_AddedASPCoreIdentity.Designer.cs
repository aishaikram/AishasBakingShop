...
namespace TheBakingCentre.Migrations
{
    ...
    [Migration("20210407192954_AddedASPCoreIdentity")]
    partial class AddedASPCoreIdentity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheBakingCentre.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("TheBakingCentre.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("TheBakingCentre.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("TheBakingCentre.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            AllergyInformation = "",
                            CategoryId = 2,
                            ImageThumbnailUrl = "/images/blueberrycheesecakesmall.jpg",
                        ...
                        new
                        {
                            ...
                            AllergyInformation = "",
                            CategoryId = 3,
                            ImageThumbnailUrl = "/images/christmasapplepiesmall.jpg",
                        ...
                        new
                        {
                            ...
                            AllergyInformation = "",
                            CategoryId = 2,
                            ImageThumbnailUrl = "/images/strawberrycheesecakesmall.jpg",
            ...
            modelBuilder.Entity("TheBakingCentre.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("TheBakingCentre.Models.OrderDetail", b =>
                {
                    b.HasOne("TheBakingCentre.Models.Order", null)
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TheBakingCentre.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TheBakingCentre.Models.Pie", b =>
                {
                    b.HasOne("TheBakingCentre.Models.Category", "Category")
                        .WithMany("Pies")
